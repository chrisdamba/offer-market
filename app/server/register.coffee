...
#
OfferMarket.registerPackage = (packageInfo) ->
	OfferMarketRegistry.Packages[packageInfo.name] = packageInfo

# Register core packages
OfferMarket.registerPackage
	name: 'core'
	autoEnable: true
	settings:
		public:
	...
	registry: [
		{
			...
			provides: 'dashboard'
			label: 'Core'
			description: 'OfferMarket Commerce Core'
			icon: 'fa fa-th'
			cycle: 1
			container: "dashboard"
			permissions: [
